...
for(sc_temp in SchoolList){
  ...
  metro2008_basic[index,eval(r_mid):= round((metro2008_basic[[z]][index] - normalized_score) * (128 - 31), 1)]
  ...
  metro2008_basic[index,eval(y):=5]
  metro2008_basic[index,eval(r_tau):= round((tau_s - normalized_score) * (128 - 31), 1)]
}
