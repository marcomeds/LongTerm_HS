...
\begin{frame}[fragile]{Intent to treat effects of being assigned to an IPN high-school}
\begin{table}[H]
\centering
...
\begin{frame}[fragile]{Intent to treat effects of being assigned to an IPN high-school using the cutoff}
\begin{table}[H]
\centering
\begin{adjustbox}{totalheight=0.88\textheight}
\begin{threeparttable}
...
\begin{frame}[fragile]{Intent to treat effects of being assigned to an IPN high-school using the MID}
\begin{table}[H]
\centering
\begin{adjustbox}{totalheight=0.88\textheight}
\begin{threeparttable}
