...
\begin{frame}[fragile]{Motivation}
  \begin{itemize}[<+->]
    ...
    \vfill\item These schools \text{do not} have better ``value-added'' in terms of academic outcomes for the marginal applicant \tiny{\citep{Adrienne2014,ElliteIllusion,DobbieFryer2014,dustan2017flourish,ParentsValueEffectiveness}}
...
%     \vfill\item \textcolor{yellow}{Cite papers about DA and first choice} have exploited the random assignment of first choices. We aim to exploit the whole list of requested schools as in \citet{abdulkadirouglu2022breaking}.
...
Example of balance across those assigned to an elite school and those who are not. \hyperlink{balance_rd_plot_app}{\beamergotobutton{Balance RD plots}}
...
\begin{frame}[fragile]{Balance across those assigned and not assigned to an elite school}
\begin{table}[H]
\centering
...
\alt<6-9>{
    \begin{itemize}
        \item[]
        \item<7-> RD around the most informative disqualification (MID).
        \item<8-> Jump is not sharp since an individual could be eligible at a higher ranked school, and this school could also be elite.
        \item<9-> Still, we observe that \textcolor{blue}{treatment is higher to the left of the MID}.
    \end{itemize}}
    {\begin{subfigure}{\textwidth}
        \centering
        \caption{Assignment to IPN around cutoff}
...
\alt<2-5>{
    \begin{itemize}
        \item[]
        \item<3-> RD around the cutoff.
        \item<4-> Jump is not sharp since, student could be eligible at a lower-ranked school, and this school could also elite.
        \item<5-> Still, we observe that \textcolor{blue}{treatment is higher to the right of the cutoff}.
    \end{itemize}}
    {\begin{subfigure}{\textwidth}
        \centering
        \caption{Assignment to IPN around MID}
...
\alt<5-7>{
    \begin{itemize}
        ...
        \item<7-> Positive ITT effect of being marginally assigned to an elite high school around the MID.
    \end{itemize}}
    {\begin{subfigure}{\textwidth}
        \centering
...
\alt<2-4>{
    \begin{itemize}
        ...
        \item[]
        \item<3-> RD around the cutoff.
        \item<4-> Negative ITT effect of being marginally assigned to an elite high school.
    \end{itemize}}
    {\begin{subfigure}{\textwidth}
        \centering
...
\begin{frame}[fragile]{Intent to treat effects of being assigned to an IPN high-schools}
\begin{table}[H]
\centering
\begin{adjustbox}{totalheight=2.3\textheight}
\begin{threeparttable}
\centering
%\caption{Intent to treat effects of being assigned to an IPN high-school}
\label{tab:ITT_EffectNoRun_IPN}
\begin{tabular}[t]{@{}l@{}l@{}l}
\toprule
\begin{tabular}[t]{lcc}
&	\multicolumn{2}{c}{1 point} \\
